...
- - - A API poderá ser acessada em http://127.0.0.1:8080

- - Microserviço Estoque:
- - - A API poderá ser acessada em http://127.0.0.1:8081

- - Microserviço Carrinho:
- - - A API poderá ser acessada em http://127.0.0.1:8082

- - Microserviço Pedidos:
- - - A API poderá ser acessada em http://127.0.0.1:8083
